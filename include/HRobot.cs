...
namespace SDKHrobot {
    ...
    class HRobot {
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int set_timer_name( int robot, int index, StringBuilder name );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_timer_name( int robot, int index, StringBuilder name );
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int get_counter_name( int robot, int index, StringBuilder name );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_counter_name( int robot, int index, StringBuilder name );
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int set_pr_comment( int robot, int index, StringBuilder comment );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_pr_comment( int robot, int index, StringBuilder comment );
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int get_module_input_config( int robot, int index, ref bool sim, ref bool value, ref int type, ref int start, ref int end, StringBuilder comment );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_module_output_config( int robot, int index, ref bool value, ref int type, ref int start, ref int end, StringBuilder comment );
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int set_module_input_comment( int robot, int index, StringBuilder comment );
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int set_module_output_comment( int robot, int index, StringBuilder comment );
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int set_digital_input_comment( int robot, int di_index, StringBuilder comment );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_digital_input_comment( int robot, int di_index, StringBuilder comment );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_digital_output_comment( int robot, int do_index, StringBuilder comment );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_digital_output_comment( int robot, int do_index, StringBuilder comment );
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int get_payload_value( int robot, ref int value );
        [DllImport( "HRSDK.dll" )]
